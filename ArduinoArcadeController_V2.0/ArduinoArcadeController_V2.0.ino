...
loop() {
  ...
  // ESC
  if(!buttonState0) {
    if(switch0_count < MAX_DEBOUNCE_COUNT)
      switch0_count++;
  ...
  // TAB
  if(!buttonState1) {
    if(switch1_count < MAX_DEBOUNCE_COUNT)
      switch1_count++;
  ...
  if(!buttonState2) {
    if(switch2_count < MAX_DEBOUNCE_COUNT)
      switch2_count++;
  ...
  if(!buttonState3) {
    if(switch3_count < MAX_DEBOUNCE_COUNT)
      switch3_count++;
  ...
  if(!buttonState4) {
    if(switch4_count < MAX_DEBOUNCE_COUNT)
      switch4_count++;
  ...
  if(!buttonState5) {
    if(switch5_count < MAX_DEBOUNCE_COUNT)
      switch5_count++;
  ...
  if(!buttonState6) {
    if(switch6_count < MAX_DEBOUNCE_COUNT)
      switch6_count++;
  ...
  if(!buttonState7) {
    if(switch7_count < MAX_DEBOUNCE_COUNT)
      switch7_count++;
  ...
  // Joystick Down
  if(!buttonState8) {
    if(switch8_count < MAX_DEBOUNCE_COUNT)
      switch8_count++;
  ...
  // Joystick Up
  if(!buttonState9) {
    if(switch9_count < MAX_DEBOUNCE_COUNT)
      switch9_count++;
  ...
  // Joystick Left
  if(!buttonState10) {
    if(switch10_count < MAX_DEBOUNCE_COUNT)
      switch10_count++;
  ...
  // Joystick Right
  if(!buttonState11) {
    if(switch11_count < MAX_DEBOUNCE_COUNT)
      switch11_count++;
  ...
  if(!buttonState12) {
    if(switch12_count < MAX_DEBOUNCE_COUNT)
      switch12_count++;
  ...
  if(!buttonState13) {
    if(switch13_count < MAX_DEBOUNCE_COUNT)
      switch13_count++;
